...
<div class="modal fade  darkmode-modal" id="delete{{$user -> id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{route('users.destroy', $user -> id)}}" method="post">
                    ...
                    <h3>Estas seguro  de borrar al usuario {{$user->name}}</h3>

...
<div class="modal fade  darkmode-modal" id="delete{{$zona -> id_zona}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{route('zonas.destroy', $zona -> id_zona)}}" method="post">
                    @csrf
                    @method('DELETE')

                    <h3>Estas seguro  de borrar {{$zona->nombre_zona}}</h3>

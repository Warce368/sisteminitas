<div class="modal fade darkmode-modal" id="delete{{$cliente->id_cliente}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{route('clientes.destroy', $cliente -> id_cliente)}}" method="post">
                    ...
                    <h3>Estas seguro  de borrar "{{$cliente -> nombre_cliente}}"</h3>

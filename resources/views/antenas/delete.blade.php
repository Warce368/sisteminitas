<div class="modal fade darkmode-modal" id="delete{{$antena -> id_antena}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="exampleModalLabel">BORRAR DIRECCION</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form action="{{route('antenas.destroy', $antena -> id_antena)}}" method="post">
                    @csrf
                    @method('DELETE')

                    <h3>Estas seguro  de borrar "{{$antena -> nombre_antena}}"</h3>

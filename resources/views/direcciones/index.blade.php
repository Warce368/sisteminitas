...
<div class="container-fluid">
        ...
        <table class="darkmode table-hover align-middle table-bordered">
            <thead class="table-dark text-center">
                <tr>
                    ...
                    <th scope="col">DIRECCION/SUBZONA</th>
    ...
    <div class="d-block d-md-none">
        ...
        <div class="card mb-3 bg-dark text-white border-secondary">
            <div class="card-header d-flex justify-content-between align-items-center py-2" data-bs-toggle="collapse"
                data-bs-target="#collapseDireccion{{$direccion->id_direccion}}" aria-expanded="false"
                style="cursor: pointer">
                <h5 class="mb-0">{{$direccion->nombre_direccion}}</h5>
                <i class="bi bi-chevron-down transition-all"></i>
            </div>

            <div class="collapse" id="collapseDireccion{{$direccion->id_direccion}}">
                <div class="card-body pt-2">
                    <div class="row g-2 mb-2">
                        <div class="col-6">
                            <small class="text-muted">ID</small>
                            <p class="mb-0">{{$direccion->id_direccion}}</p>
                        </div>
                        <div class="col-6">
                            <small class="text-muted">ZONA</small>
                            <p class="mb-0">{{ $direccion->zona->nombre_zona ?? 'No asignado' }}</p>
                        </div>
                    </div>
    ...
    <div class="flex justify-content-between align-items-center mt-3">
        <div>
            {{ $direcciones->links('pagination::bootstrap-5') }}
        </div>
    </div>
</div>

<!-- Incluir modales -->
@include('direcciones.create')

@foreach ($direcciones as $direccion)
@include('direcciones.edite', ['direccion' => $direccion])
@include('direcciones.delete', ['direccion' => $direccion])
@endforeach
...
<!-- AQUI ESTA EL PADRE DEL MODELO MOVIL-->
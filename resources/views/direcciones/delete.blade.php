<div class="modal fade darkmode-modal" id="delete{{$direccion -> id_direccion}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{route('direcciones.destroy', $direccion -> id_direccion)}}" method="post">
                    ...
                    <h3>Estas seguro  de borrar "{{$direccion->nombre_direccion}}"</h3>

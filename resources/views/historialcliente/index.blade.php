...
<div class="container-fluid">
    ...
    <form method="GET" class="row gy-2 gx-2 align-items-center mb-3 text-white">
        ...
        <div class="col-12 col-sm-6 col-md-3">
            <label class="form-label mb-1 text-white">Cliente:</label>
            <select name="id_cliente" class="form-select bg-dark text-white border-secondary small-select"
        ...
        <!-- Filtro por año -->
        <div class="col-12 col-sm-6 col-md-3">
            <label class="form-label mb-1 text-white">Año:</label>
            <select name="anio" class="form-select bg-dark text-white border-secondary small-select"
                onchange="this.form.submit()">
                @foreach ($mesesAnios->pluck('anio')->unique() as $anio)
                <option value="{{ $anio }}" {{ $anio==$anioFiltro ? 'selected' : '' }}>{{ $anio }}</option>
                @endforeach
            </select>
        </div>
